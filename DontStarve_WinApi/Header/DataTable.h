...
struct DataTable
{
	...
	static constexpr ToolInfo ToolTable[] = {
		{ GOID_TOOL_GOLDEN_PICKAXE, L"황금 곡괭이", L"수확을 위한 황금 곡괭이입니다.", 35, 120.0f },
		{ GOID_TOOL_HAM_BAT,        L"햄 뱃",       L"고기로 만든 무기입니다.",       40, 100.0f },
		{ GOID_TOOL_PICKAXE,        L"곡괭이",     L"바위와 광석을 캡니다.",         15, 80.0f  },
		{ GOID_TOOL_SPEAR,          L"창",         L"전투를 위한 단순한 창입니다.",   30, 150.0f },
		{ GOID_TOOL_SWAP_SPEAR,     L"스왑 스피어", L"번개의 힘이 깃든 창입니다.",     45, 160.0f },
		{ GOID_TOOL_TORCH,          L"횃불",       L"어둠 속에서 빛을 밝힙니다.",     10, 90.0f  },
		{ GOID_TOOL_RED_AXE,        L"빨간 도끼",   L"나무를 베는 데 사용합니다.",     35, 100.0f },
		{ GOID_TOOL_SWAP_AXE,       L"도끼",   L"특별한 속성을 가진 도끼입니다.",  150, 100.0f },
