...
{
	// TitleScene에서는 UIManager와 InputManager 업데이트
...
{
	// TitleScene에서는 UIManager와 InputManager LateUpdate
...
{
	// TitleScene에서는 UIManager와 InputManager 렌더링
...
void TitleScene::InitializeManagers()
{
	...
	// TitleScene에서는 UIManager와 InputManager 초기화
