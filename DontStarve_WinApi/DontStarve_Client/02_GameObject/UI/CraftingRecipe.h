...
static constexpr CraftingRecipeEntry CraftingRecipeTable[] = {
	{ GOID_TOOL_GOLDEN_PICKAXE, GOID_ITEM_GOLD_ROCK, 1, GOID_ITEM_NORMAL_TREE_LOG, 1 },
	{ GOID_TOOL_HAM_BAT, GOID_ITEM_MEAT, 1, GOID_ITEM_NORMAL_TREE_LOG, 1 },
	{ GOID_TOOL_PICKAXE, GOID_ITEM_NORMAL_TWIGS, 1, GOID_ITEM_NORMAL_TREE_LOG, 1 },
	{ GOID_TOOL_RED_AXE, GOID_ITEM_GOLD_ROCK, 1, GOID_ITEM_NORMAL_TREE_LOG, 1 },
	{ GOID_TOOL_SPEAR, GOID_ITEM_NORMAL_TWIGS, 2, GOID_ITEM_NORMAL_TREE_LOG, 2 },
	{ GOID_TOOL_SWAP_AXE, GOID_ITEM_NORMAL_ROCK, 1, GOID_ITEM_NORMAL_TWIGS, 1 },
	{ GOID_TOOL_SWAP_SPEAR, GOID_ITEM_ROPE, 1, GOID_ITEM_NORMAL_ROCK, 2 },
	{ GOID_TOOL_TORCH, GOID_ITEM_NORMAL_TWIGS, 2, GOID_NONE, 0 },
	{ GOID_TOOL_HALBERD, GOID_ITEM_WOOD_2, 1, GOID_ITEM_CUT_NORMAL_STONE, 1 },
	{ GOID_TOOL_HAMMER, GOID_ITEM_NORMAL_TWIGS, 1, GOID_ITEM_NORMAL_ROCK, 2 },
	// 제작 재료 (CreateIcon)
